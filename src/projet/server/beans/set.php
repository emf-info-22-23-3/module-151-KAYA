...
/**
 * Classe Set représentant un ensemble (set) d'équipements liés à un utilisateur.
 */
class Set {
    // Attributs privés représentant les colonnes de la table "set"
    private $pk_set;
    private $fk_user;
    private $nom;
    private $cap_nom;
    ...
    /**
     * Convertit l'objet Set en une représentation XML sécurisée.
     * @return string XML
     */
